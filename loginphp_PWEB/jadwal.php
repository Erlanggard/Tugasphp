...
<body>
    <ul class="nav flex-column">
        ...
        <li class="nav-item">
          <a class="nav-link active nav" aria-current="page" href="beranda.php">Beranda</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="Biodata.php">Biodata</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="jadwal.php"><p class="text-white bg-primary">Jadwal Kuliah</p></a>
        </li>
      </ul>
